...
func TransVid(nvid string) {
  cmd := exec.Command(".\\ffmpeg-master-latest-win64-gpl\\bin\\ffmpeg.exe", "-y", "-i", "uploads\\" + nvid,"-af", "afade,dynaudnorm,equalizer=f=1000:t=h:width_type=o:width=2:g=5,equalizer=f=100:t=1:width_type=o:width=2:g=-5,adeclip,afade,acompressor", "-b:a", "192k", "-vn", "static\\output\\" + nvid + ".mp3")
